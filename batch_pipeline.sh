...
--allow-no-sex \
--keep /nfs/users/nfs_m/mc14/Work/SANGER/UK10K/BATCHEFF/3621_${cohort}_samples.keeplist \
--pheno /nfs/users/nfs_m/mc14/Work/SANGER/UK10K/BATCHEFF/${cohort}_samples_pheno.centre \
--assoc --within --adjust --out chr${chr}.txt
...
--keep /nfs/users/nfs_m/mc14/Work/SANGER/UK10K/BATCHEFF/3621_${cohort}_samples.keeplist \
--pheno /nfs/users/nfs_m/mc14/Work/SANGER/UK10K/BATCHEFF/${cohort}_samples_pheno.centre \
--maf 0.01 --assoc --adjust --out chr${chr}.txt
...
#This last would be for the RARE variants (MAF < 0.01)
...
#This is for the whole genome (unpruned) set
# cohort="ALSPAC"
# cohort="TWINSUK"
# for cohort in JOINT
...
do
    ...
    outdir=/lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/${cohort_path}/UNPRUNED/logistic_all
    mkdir -p ${outdir}
...
do
    ...
    outdir=/lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/${cohort_path}/UNPRUNED/logistic/REMOVELIST
...
bsub -J "plink_freq_${cohort}" -o "%J_plink_freq_${cohort}.o" -P "analysis-rd" -M 30000000 -R"select[mem>30000] rusage[mem=30000]" -q normal -- plink --noweb \
...
--freq \
--out /lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/input/${cohort}_all_chr_merged_unpruned

done
# Do this for Twins and Alspac 
...
for chr in {1..22}
do
    mkdir -p /lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/twins/PRUNED/MDS/FILTERED_5e6/CHR${chr}

let i=0 a=17;let j=0;
...
--allow-no-sex \
--maf 0.01 \
--exclude /lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/twins/PRUNED/REMOVELIST/chr${chr}.txt.assoc.TWINSUK.5e-6.removelist \
--read-freq /lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/twins/PRUNED/MDS/chr${chr}.freq.frq \
--genome \
--genome-lists /lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/twins/PRUNED/MDS/tmp.list`printf "%03i\n" $i` \
/lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/twins/PRUNED/MDS/tmp.list`printf "%03i\n" $j` \
--out /lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/twins/PRUNED/MDS/FILTERED_5e6/CHR${chr}/data.sub.$i.$j
...
bsub -J "plink_run_${i}_${j}" -o "%J_plink_run_${i}_${j}.o" -M 4000 -R"select[mem>4000] rusage[mem=4000]" -q yesterday -- plink --noweb \
...
--maf 0.01 \
--read-freq /lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/twins/PRUNED/MDS/GW/gwa_data_freq.frq \
--genome \
--genome-lists /lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/twins/PRUNED/MDS/tmp.list`printf "%03i\n" $i` \
/lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/twins/PRUNED/MDS/tmp.list`printf "%03i\n" $j` \
--out /lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/twins/PRUNED/MDS/GW/FILTERED_1e5_1/data.sub.$i.$j
...
--exclude /lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/twins/PRUNED/REMOVELIST/chr${chr}.txt.assoc.TWINSUK.5e-8.removelist \
...
outdir=/lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/${cohort_path}/PRUNED/MDS/${filter}/CHR${chr}/REMOVED_REGION_filtered
mkdir -p ${outdir}

a=$[`ls /lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/${cohort_path}/PRUNED/MDS/tmp.list*| wc -l`-1]
...
bsub -J "plink_run_${i}_${j}_${chr}" -o "%J_plink_run_${i}_${j}_${chr}.o" -P "analysis-rd" -M 4000000 -R"select[mem>4000] rusage[mem=4000]" -q normal -- plink --noweb \
--bed /lustre/scratch113/projects/uk10k/users/jh21/references_panel/uk10k/plink/chr${chr}.pruned.bed \
--bim /lustre/scratch113/projects/uk10k/users/jh21/references_panel/uk10k/plink/chr${chr}.pruned.bim.COPY \
--fam /lustre/scratch113/projects/uk10k/users/jh21/references_panel/uk10k/plink/chr${chr}.pruned.fam \
--exclude /lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/${cohort_path}/PRUNED/MDS/UNFILTERED_1/CHR${chr}/logistic/${cohort}_CHR${chr}_joint.removelist \
--maf 0.01 \
--allow-no-sex \
--read-freq /lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/${cohort_path}/PRUNED/MDS/chr${chr}.freq.frq \
--genome \
--genome-lists /lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/${cohort_path}/PRUNED/MDS/tmp.list`printf "%03i\n" $i` \
/lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/${cohort_path}/PRUNED/MDS/tmp.list`printf "%03i\n" $j` \
...
--read-freq /lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/${cohort_path}/PRUNED/MDS/GW/gwa_data_freq.frq \
--genome \
--genome-lists /lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/${cohort_path}/PRUNED/MDS/tmp.list`printf "%03i\n" $i` \
/lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/${cohort_path}/PRUNED/MDS/tmp.list`printf "%03i\n" $j` \
--out ${outdir}/data.sub.$i.$j
...
--out /lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/alspac/PRUNED/MDS/GW/FILTERED_1e5_1/data.sub.$i.$j
--exclude /lustre/scratch113/projects/uk10k/cohorts/REL-2012-06-02/v2/batch_effect/${cohort_path}/PRUNED/MDS/GW/All.txt.assoc.logistic.${cohort}.1e-2.joint_gwa.removelist \
