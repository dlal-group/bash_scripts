...
if [ -f $remap\_remapsorted.bam ]; then
        ...
        /software/hgi/pkglocal/samtools-1.2/bin/samtools view -H $remap\_remapsorted.bam|grep "^@SQ\|^@HD" >$2/$bam_name\_header.txt
        /software/hgi/pkglocal/samtools-1.2/bin/samtools view -H $bam|grep -v "^@SQ\|^@HD" >>$2/$bam_name\_header.txt
