...
#step1_id=`qsub -N ${trait}_${chr} -o $out_path/LOGS/s1_chr${chr}.log -e $out_path/LOGS/s1_chr${chr}.err -l mem=16gb -q workq -- /lustre1/workspace/Toniolo/scripts/bash_scripts/gemma_extract_snp_list.sh $rs_to_include_path $imp_file_path/CHR${chr}/MERGED/chr${chr}.geno_info_merged.geno_info_wheighted $out_path/rs_to_remove_${chr}.list`
step1_id=`qsub -N ${trait}_${chr} -o $out_path/LOGS/s1_chr${chr}.log -e $out_path/LOGS/s1_chr${chr}.err -l mem=16gb -q workq -- /lustre1/workspace/Toniolo/scripts/bash_scripts/gemma_extract_snp_list.sh $rs_to_include_path $imp_file_path/CHR${chr}/chr${chr}.geno_info $out_path/rs_to_remove_${chr}.list`

#Second step:
#Stats extraction
echo "Step 2...(to be due after ${step1_id})"
#echo "Step 2..."
#bsub -J "s2_${trait}_chr${chr}" -o "$out_path/LOGS/%J_s2_chr${chr}.log" -e "$out_path/LOGS/%J_s2_chr${chr}.err" -w "ended(s1_${trait}_chr${chr})" -G "team151" -M8000000 -R"select[mem>8000] rusage[mem=8000]" -q normal snptest_v2 -summary_stats_only -data $imp_file_path/CHR${chr}/chr${chr}.gen.gz $sample_file_path -exclude_snps $out_path/rs_to_remove_${chr}.list -exclude_samples $sample_to_remove_path -hwe -log $out_path/chr${chr}_filtered.log -o $out_path/${stat_filename}.${chr}.stats
#step2_id=`qsub -N ${trait}_${chr} -o $out_path/LOGS/s2_chr${chr}.log -e $out_path/LOGS/s2_chr${chr}.err -l mem=8gb -W depend=afterok:${step1_id} -q workq -- /lustre1/tools/bin/snptest -summary_stats_only -data $imp_file_path/CHR${chr}/MERGED/chr${chr}.geno.gz $sample_file_path -exclude_snps $out_path/rs_to_remove_${chr}.list -exclude_samples $sample_to_remove_path -hwe -log $out_path/chr${chr}_filtered.log -o $out_path/${stat_filename}.${chr}.stats`
step2_id=`qsub -N ${trait}_${chr} -o $out_path/LOGS/s2_chr${chr}.log -e $out_path/LOGS/s2_chr${chr}.err -l mem=8gb -W depend=afterok:${step1_id} -q workq -- /lustre1/tools/bin/snptest -summary_stats_only -data $imp_file_path/CHR${chr}/chr${chr}.geno.gz $sample_file_path -exclude_snps $out_path/rs_to_remove_${chr}.list -exclude_samples $sample_to_remove_path -hwe -log $out_path/chr${chr}_filtered.log -o $out_path/${stat_filename}.${chr}.stats`
#qsub -N ${trait}_${chr} -o $out_path/LOGS/s2_chr${chr}.log -e $out_path/LOGS/s2_chr${chr}.err -l mem=8gb -q workq -- /lustre1/tools/bin/snptest -summary_stats_only -data $imp_file_path/CHR${chr}/MERGED/chr${chr}.geno.gz $sample_file_path -exclude_snps $out_path/rs_to_remove_${chr}.list -exclude_samples $sample_to_remove_path -hwe -log $out_path/chr${chr}_filtered.log -o $out_path/${stat_filename}.${chr}.stats
...
#bsub -J "s3_${trait}_chr${chr}" -w "ended(s2_${trait}_chr${chr})" -o "$out_path/LOGS/%J_s3_chr${chr}.log" -e "$out_path/LOGS/%J_s3_chr${chr}.err" -G "team151" -M8000000 -R"select[mem>8000] rusage[mem=8000]" -q normal /nfs/users/nfs_m/mc14/Work/bash_scripts/reorder_gemma_stats.sh $out_path $out_path/${stat_filename}.${chr}.stats $imp_file_path/CHR${chr}/chr${chr}.gen_info ${chr}
#qsub -N ${trait}_${chr} -o $out_path/LOGS/s3_chr${chr}.log -e $out_path/LOGS/s3_chr${chr}.err -l mem=8gb -W depend=afterok:${step2_id} -q workq -- /lustre1/workspace/Toniolo/scripts/bash_scripts/reorder_gemma_stats.sh $out_path $out_path/${stat_filename}.${chr}.stats $imp_file_path/CHR${chr}/MERGED/chr${chr}.geno_info_merged.geno_info_wheighted ${chr}
qsub -N ${trait}_${chr} -o $out_path/LOGS/s3_chr${chr}.log -e $out_path/LOGS/s3_chr${chr}.err -l mem=8gb -W depend=afterok:${step2_id} -q workq -- /lustre1/workspace/Toniolo/scripts/bash_scripts/reorder_gemma_stats.sh $out_path $out_path/${stat_filename}.${chr}.stats $imp_file_path/CHR${chr}/chr${chr}.geno_info ${chr}
