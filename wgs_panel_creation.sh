...
bsub -J"extract_common_ingi_snps_aceq1dpgt5_${first_suffix}_TGP3" -o"%J_extract_common_ingi_snps_aceq1dpgt5_${first_suffix}_TGP3.o" -w "ended(extract_common_ingi_snps_aceq1dpgt5_${first_suffix}_INGI)" -M 3000 -R "select[mem>=3000] rusage[mem=3000]" -q normal --  python /nfs/users/nfs_m/mc14/Work/bash_scripts/overlap_check.py TGP3 ${outdir}/${filename}.snps_ac1dp5.tab.INGI.not_over.tab /lustre/scratch113/projects/esgi-vbseq/16112015_TRIESTE/TGPph3/UNION/${chr}/sites.txt ${outdir}
bsub -J"extract_common_ingi_snps_aceq1dpgt5_${first_suffix}_UK10K" -o"%J_extract_common_ingi_snps_aceq1dpgt5_${first_suffix}_UK10K.o" -w "ended(extract_common_ingi_snps_aceq1dpgt5_${first_suffix}_INGI)" -M 3000 -R "select[mem>=3000] rusage[mem=3000]" -q normal --  python /nfs/users/nfs_m/mc14/Work/bash_scripts/overlap_check.py UK10K ${outdir}/${filename}.snps_ac1dp5.tab.INGI.not_over.tab /lustre/scratch113/projects/esgi-vbseq/16112015_TRIESTE/UK10K/UNION/${chr}/sites.txt ${outdir}
