...
# it works with multiple populations and by chromosomes, to parallelize all
# test
...
vcf=$1
outdir=/lustre/scratch113/projects/esgi-vbseq/27112015_INGI_REF_PANEL/$2
...
# var_list=sys.argv[1]
# overlap_list=sys.argv[2]
# outdir=sys.argv[3]
bsub -J"extract_common_ingi_snps_aceq1dpgt5_${first_suffix}_INGI" -o"%J_extract_common_ingi_snps_aceq1dpgt5_${first_suffix}_INGI.o" -w "ended()" -M 3000 -R "select[mem>=3000] rusage[mem=3000]" -q normal --  python overlap_check.py INGI ${outdir}/${filename}.snps_ac1dp5.tab /lustre/scratch113/projects/esgi-vbseq/16112015_TRIESTE/INGI/UNION/${chr}/sites.txt ${outdir}
bsub -J"extract_common_ingi_snps_aceq1dpgt5_${first_suffix}_TGP3" -o"%J_extract_common_ingi_snps_aceq1dpgt5_${first_suffix}_TGP3.o" -w "ended()" -M 3000 -R "select[mem>=3000] rusage[mem=3000]" -q normal --  python overlap_check.py TGP3 ${outdir}/${filename}.snps_ac1dp5.tab.not_over.tab /lustre/scratch113/projects/esgi-vbseq/16112015_TRIESTE/TGP3/UNION/${chr}/sites.txt ${outdir}
bsub -J"extract_common_ingi_snps_aceq1dpgt5_${first_suffix}_UK10K" -o"%J_extract_common_ingi_snps_aceq1dpgt5_${first_suffix}_UK10K.o" -w "ended()" -M 3000 -R "select[mem>=3000] rusage[mem=3000]" -q normal --  python overlap_check.py UK10K ${outdir}/${filename}.snps_ac1dp5.tab.not_over.tab /lustre/scratch113/projects/esgi-vbseq/16112015_TRIESTE/UK10K/UNION/${chr}/sites.txt ${outdir}
