...
bsub -J"extract_common_ingi_${mode}_${cohort}_aceq1dpgt5_${first_suffix}_INGI" -o"${outdir}/LOG_OVERLAPS/4.%J_extract_common_ingi_${mode}_${cohort}_aceq1dpgt5_${first_suffix}_INGI.o" -w "ended(extract_${mode}_${cohort}_aceq1dpgt5_${first_suffix})" -M 1000 -R "select[mem>=1000] rusage[mem=1000]" -q normal -- python /nfs/users/nfs_m/mc14/Work/bash_scripts/overlap_check.py INGI ${outdir}/${filename}.${mode}_ac1dp5.tab /lustre/scratch113/projects/esgi-vbseq/09022016_PANEL_SESOURCES/INGI/UNION/${chr}/sites.txt ${outdir} ${mode}

#extract a list of sites in common with 1000G or/and UK10K
bsub -J"extract_common_ingi_${mode}_${cohort}_aceq1dpgt5_${first_suffix}_TGP3" -o"${outdir}/LOG_OVERLAPS/5.%J_extract_common_ingi_${mode}_${cohort}_aceq1dpgt5_${first_suffix}_TGP3.o" -w "ended(extract_common_ingi_${mode}_${cohort}_aceq1dpgt5_${first_suffix}_INGI)" -M 2000 -R "select[mem>=2000] rusage[mem=2000]" -q normal -- python /nfs/users/nfs_m/mc14/Work/bash_scripts/overlap_check.py TGP3 ${outdir}/${filename}.${mode}_ac1dp5.tab.INGI.${mode}.not_over.tab /lustre/scratch113/projects/esgi-vbseq/09022016_PANEL_SESOURCES/TGPph3/UNION/${chr}/sites.txt ${outdir} ${mode}
bsub -J"extract_common_ingi_${mode}_${cohort}_aceq1dpgt5_${first_suffix}_UK10K" -o"${outdir}/LOG_OVERLAPS/6.%J_extract_common_ingi_${mode}_${cohort}_aceq1dpgt5_${first_suffix}_UK10K.o" -w "ended(extract_common_ingi_${mode}_${cohort}_aceq1dpgt5_${first_suffix}_INGI)" -M 2000 -R "select[mem>=2000] rusage[mem=2000]" -q normal -- python /nfs/users/nfs_m/mc14/Work/bash_scripts/overlap_check.py UK10K ${outdir}/${filename}.${mode}_ac1dp5.tab.INGI.${mode}.not_over.tab /lustre/scratch113/projects/esgi-vbseq/09022016_PANEL_SESOURCES/UK10K/UNION/${chr}/sites.txt ${outdir} ${mode}
...
bsub -J"generate_ingi_${mode}_${first_suffix}_${cohort}_vcf" -o"${outdir}/LOG_PANEL/8.%J_generate_ingi_${mode}_${first_suffix}_${cohort}_vcf.o" -w"ended(merge_common_ingi_${mode}_aceq0eq1gt2dpgt5_${first_suffix}_${cohort})" -M 3000 -R "select[mem>=3000] rusage[mem=3000]" -q normal -- bcftools view -i"TYPE='${mode}'" -R ${outdir}/${filename}.${mode}_extract.list -O z -o ${outdir}/PANEL/${filename}.${mode}_REF.vcf.gz ${vcf}
