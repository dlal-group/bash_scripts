...
echo "cat ${outdir}/${chr}/${filename}.${mode}_ac0dp5.tab ${outdir}/${chr}/${filename}.${mode}_ac2dp5.tab ${outdir}/${chr}/${filename}.${mode}_ac1dp5.tab.INGI.${mode}.over.tab ${outdir}/${chr}/${filename}.${mode}_ac1dp5.tab.INGI.${mode}.not_over.tab.TGP3.${mode}.over.tab ${outdir}/${chr}/${filename}.${mode}_ac1dp5.tab.INGI.${mode}.not_over.tab.UK10K.${mode}.over.tab | cut -f -4 | sort -g -k1,1 -k2,2 | uniq| awk 'BEGIN{OFS=\"\t\"}{print \$0,\"REF_PANEL\"}' | bgzip -c > ${outdir}/${chr}/${filename}.${mode}_extract_annotation.list.gz" | bsub -J"merge_common_ingi_${mode}_aceq0eq1gt2dpgt5_${first_suffix}_${cohort}" -o"${outdir}/LOG_OVERLAPS/7.%J_merge_common_ingi_${mode}_aceq0eq1gt2dpgt5_${first_suffix}_${cohort}.o" -M 1000 -R "select[mem>=1000] rusage[mem=1000]" -q normal
bsub -J"merge_common_ingi_${mode}_aceq0eq1gt2dpgt5_${first_suffix}_${cohort}_tbi" -o"${outdir}/LOG_OVERLAPS/8.%J_merge_common_ingi_${mode}_aceq0eq1gt2dpgt5_${first_suffix}_${cohort}_tbi.o" -w "ended(merge_common_ingi_${mode}_aceq0eq1gt2dpgt5_${first_suffix}_${cohort})" -M 1000 -R "select[mem>=1000] rusage[mem=1000]" -q normal -- tabix -b 2 -e 2 -s 1 -f ${outdir}/${chr}/${filename}.${mode}_extract_annotation.list.gz

bsub -J"annotate_ingi_${mode}_${first_suffix}_${cohort}_vcf" -o"${outdir}/LOG_PANEL/9.%J_annotate_ingi_${mode}_${first_suffix}_${cohort}_vcf.o" -w"ended(merge_common_ingi_${mode}_aceq0eq1gt2dpgt5_${first_suffix}_${cohort}_tbi)" -M 2000 -R "select[mem>=2000] rusage[mem=2000]" -q normal -- bcftools annotate -a ${outdir}/${chr}/${filename}.${mode}_extract_annotation.list.gz -m REF_PANEL -c CHROM,POS,REF,ALT -O z -o ${outdir}/PANEL/${filename}.${mode}_annREF.vcf.gz ${vcf} 
...
bsub -J"extract_ingi_${mode}_${first_suffix}_${cohort}_vcf_tbi" -o"${outdir}/LOG_PANEL/12.%J_extract_ingi_${mode}_${first_suffix}_${cohort}_vcf_tbi.o" -w"ended(extract_ingi_${mode}_${first_suffix}_${cohort}_vcf)" -M 2000 -R "select[mem>=2000] rusage[mem=2000]" -q normal -- tabix -f -p vcf ${outdir}/PANEL/${filename}.${mode}_REF.vcf.gz
;;
CLEAN)
echo "Cleaning step!!!"
...
bsub -J"clean_ingi_${mode}_${first_suffix}_${cohort}_keeplist_extract" -o"${outdir}/LOG_PANEL/14.%J_clean_ingi_${mode}_${first_suffix}_${cohort}_keeplist_extract.o" -w"ended(clean_ingi_${mode}_${first_suffix}_${cohort}_keeplist)" -M200 -R "select[mem>=200] rusage[mem=200]" -q normal -- /nfs/users/nfs_m/mc14/Work/bash_scripts/dupe_extract.sh ${outdir}/PANEL/${filename}.${mode}_REF_keep.tab ${outdir}/PANEL/${filename}.${mode}_REF_keep_dupe_pos.tab ${outdir}/PANEL/${filename}.${mode}_REF_keep_dupe_sites.tab

#now use the python script to mark sites to keep
bsub -J"clean_ingi_${mode}_${first_suffix}_${cohort}_keeplist_annotate" -o"${outdir}/LOG_PANEL/15.%J_clean_ingi_${mode}_${first_suffix}_${cohort}_keeplist_annotate.o" -w"ended(clean_ingi_${mode}_${first_suffix}_${cohort}_keeplist_extract)" -M 2000 -R "select[mem>=2000] rusage[mem=2000]" -q normal -- python /nfs/users/nfs_m/mc14/Work/bash_scripts/panel_check.py ${cohort} ${outdir}/PANEL/${filename}.${mode}_REF_keep.tab ${outdir}/PANEL/${filename}.${mode}_REF_keep_dupe_pos.tab ${outdir}/PANEL/${filename}.${mode}_REF_keep_dupe_sites.tab ${outdir}/PANEL/ ${mode}

#bgzip and index the thing
echo "sort -g -k2,2 ${outdir}/PANEL/${filename}.${mode}_REF_keep.tab.${cohort}.${mode}.to_keep.tab| bgzip -c > ${outdir}/PANEL/${filename}.${mode}_REF_keep.tab.${cohort}.${mode}.to_keep.tab.gz" | bsub -J"clean_ingi_${mode}_${first_suffix}_${cohort}_keeplist_gzip" -o"${outdir}/LOG_PANEL/16.%J_clean_ingi_${mode}_${first_suffix}_${cohort}_keeplist_gzip.o" -w"ended(clean_ingi_${mode}_${first_suffix}_${cohort}_keeplist_annotate)" -M 2000 -R "select[mem>=2000] rusage[mem=2000]" -q normal

bsub -J"clean_ingi_${mode}_${first_suffix}_${cohort}_keeplist_gzip_index" -o"${outdir}/LOG_PANEL/17.%J_clean_ingi_${mode}_${first_suffix}_${cohort}_keeplist_gzip_index.o" -w"ended(clean_ingi_${mode}_${first_suffix}_${cohort}_keeplist_gzip)" -M 2000 -R "select[mem>=2000] rusage[mem=2000]" -q normal -- tabix -f -s 1 -b 2 -e 2 ${outdir}/PANEL/${filename}.${mode}_REF_keep.tab.${cohort}.${mode}.to_keep.tab.gz

#now use the indexed file to annotate the vcf and than extract the final variant set
bsub -J"clean_annotate_ingi_${mode}_${first_suffix}_${cohort}_vcf" -o"${outdir}/LOG_PANEL/18.%J_clean_annotate_ingi_${mode}_${first_suffix}_${cohort}_vcf.o" -w"ended(clean_ingi_${mode}_${first_suffix}_${cohort}_keeplist_gzip_index)" -M 2000 -R "select[mem>=2000] rusage[mem=2000]" -q normal -- bcftools annotate -a ${outdir}/PANEL/${filename}.${mode}_REF_keep.tab.${cohort}.${mode}.to_keep.tab.gz -m KEEP -c CHROM,POS,REF,ALT -O z -o ${outdir}/PANEL/${filename}.${mode}_KEEP_REF.vcf.gz ${outdir}/PANEL/${filename}.${mode}_REF.vcf.gz
bsub -J"clean_annotate_ingi_${mode}_${first_suffix}_${cohort}_vcf_tbi" -o"${outdir}/LOG_PANEL/19.%J_clean_annotate_ingi_${mode}_${first_suffix}_${cohort}_vcf_tbi.o" -w"ended(clean_annotate_ingi_${mode}_${first_suffix}_${cohort}_vcf)" -M 2000 -R "select[mem>=2000] rusage[mem=2000]" -q normal -- tabix -f -p vcf ${outdir}/PANEL/${filename}.${mode}_KEEP_REF.vcf.gz
...
#now we do the last round of cleaning to generate the correct vcf file
# bsub -J"extract_final_clean_ingi_${mode}_${first_suffix}_${cohort}_vcf" -o"${outdir}/LOG_PANEL/22.%J_extract_final_clean_ingi_${mode}_${first_suffix}_${cohort}_vcf.o" -w"ended(extract_clean_ingi_${mode}_${first_suffix}_${cohort}_vcf_tbi)" -M 2000 -R "select[mem>=2000] rusage[mem=2000]" -q normal -- /nfs/users/nfs_m/mc14/Work/bash_scripts/last_vcf.sh ${outdir}/PANEL/${filename}.${mode}_clean_REF.vcf.gz ${cohort} ${outdir}/PANEL/${filename}.${mode}_REF_keep.tab.${cohort}.${mode}.to_keep.tab ${outdir}/PANEL ${mode}
#this filter needs to be performed on INDEL ONLY
...
bsub -J"merge_${first_suffix}_${cohort}_vcf" -o"${outdir}/LOG_PANEL/23.%J_merge_${first_suffix}_${cohort}_vcf.o" -M 1000 -R "select[mem>=1000] rusage[mem=1000]" -q normal -- bcftools concat -a ${outdir}/PANEL/${filename}.snp_clean_REF.vcf.gz ${outdir}/PANEL/${filename}.indel_REF_keep.tab.${cohort}.indel.to_keep.tab.${cohort}.indel.to_keep.vcf.gz -O z -o ${outdir}/PANEL/${filename}.ALL_REF.vcf.gz
bsub -J"merge_${first_suffix}_${cohort}_vcf_tbi" -o"${outdir}/LOG_PANEL/24.%J_merge_${first_suffix}_${cohort}_vcf_tbi.o" -w"ended(merge_${first_suffix}_${cohort}_vcf)" -M 1000 -R "select[mem>=1000] rusage[mem=1000]" -q normal -- tabix -f -p vcf ${outdir}/PANEL/${filename}.ALL_REF.vcf.gz
echo "bcftools stats -v -F /lustre/scratch114/resources/ref/Homo_sapiens/1000Genomes_hs37d5/hs37d5.fa ${outdir}/PANEL/${filename}.ALL_REF.vcf.gz > ${outdir}/PANEL/${filename}.ALL_REF.vcf.gz.vcfchk" | bsub -J"stats_merged_${first_suffix}_${cohort}_vcf" -o"${outdir}/LOG_PANEL/25.%J_stats_merged_${first_suffix}_${cohort}.o" -w"ended(merge_${first_suffix}_${cohort}_vcf_tbi)" -M 1000 -R "select[mem>=1000] rusage[mem=1000]" -q normal
...
#now use the indexed file to annotate the vcf and than extract the final variant set
bsub -J"clean_annotate_ingi_${mode}_${first_suffix}_${cohort}_vcf" -o"${outdir}/LOG_PANEL/18.%J_clean_annotate_ingi_${mode}_${first_suffix}_${cohort}_vcf.o" -w"ended(clean_ingi_${mode}_${first_suffix}_${cohort}_keeplist_gzip_index)" -M 2000 -R "select[mem>=2000] rusage[mem=2000]" -q normal -- bcftools annotate -a ${outdir}/PANEL/${filename}.${mode}_REF_keep.tab.${cohort}.${mode}.to_keep.tab.gz -m KEEP -c CHROM,POS,REF,ALT,INFO/DP4,INFO/DP,INFO/HOB,INFO/ICB,INFO/IDV -O z -o ${outdir}/PANEL/${filename}.${mode}_KEEP_REF.vcf.gz ${outdir}/PANEL/${filename}.${mode}_REF.vcf.gz
bsub -J"clean_annotate_ingi_${mode}_${first_suffix}_${cohort}_vcf_tbi" -o"${outdir}/LOG_PANEL/19.%J_clean_annotate_ingi_${mode}_${first_suffix}_${cohort}_vcf_tbi.o" -w"ended(clean_annotate_ingi_${mode}_${first_suffix}_${cohort}_vcf)" -M 2000 -R "select[mem>=2000] rusage[mem=2000]" -q normal -- tabix -f -p vcf ${outdir}/PANEL/${filename}.${mode}_KEEP_REF.vcf.gz
...
# add a bit for merg back SNP and INDEls
echo "Merge step!"
bsub -J"merge_${first_suffix}_${cohort}_vcf" -o"${outdir}/LOG_PANEL/22.%J_merge_${first_suffix}_${cohort}_vcf.o" -w"ended(extract_ingi_snp_${first_suffix}_${cohort}_vcf_tbi) && ended(extract_ingi_indel_${first_suffix}_${cohort}_vcf_tbi)" -M 1000 -R "select[mem>=1000] rusage[mem=1000]" -q normal -- bcftools concat -a  ${outdir}/PANEL/${filename}.snp_REF.vcf.gz ${outdir}/PANEL/${filename}.indel_REF.vcf.gz -O z -o ${outdir}/PANEL/${filename}.ALL_REF.vcf.gz
...
bsub -J"merge_${first_suffix}_${cohort}_vcf_tbi" -o"${outdir}/LOG_PANEL/23.%J_merge_${first_suffix}_${cohort}_vcf_tbi.o" -w"ended(merge_${first_suffix}_${cohort}_vcf)" -M 1000 -R "select[mem>=1000] rusage[mem=1000]" -q normal -- tabix -p vcf ${outdir}/PANEL/${filename}.ALL_REF.vcf.gz
echo "bcftools stats -v -F /lustre/scratch114/resources/ref/Homo_sapiens/1000Genomes_hs37d5/hs37d5.fa ${outdir}/PANEL/${filename}.ALL_REF.vcf.gz > ${outdir}/PANEL/${filename}.ALL_REF.vcf.gz.vcfchk" | bsub -J"stats_merged_${first_suffix}_${cohort}_vcf" -o"${outdir}/LOG_PANEL/24.%J_stats_merged_${first_suffix}_${cohort}.o" -w"ended(merge_${first_suffix}_${cohort}_vcf_tbi)" -M 1000 -R "select[mem>=1000] rusage[mem=1000]" -q normal
