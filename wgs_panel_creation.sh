...
bsub -J"extract_${mode}_${cohort}_acgt2dpgt5_${first_suffix}" -o"${outdir}/LOG/1.%J_extract_${mode}_${cohort}_acgt2dpgt5_${first_suffix}.o" -M 1000 -R "select[mem>=1000] rusage[mem=1000]" -q normal -- bcftools query -i"TYPE='${mode}' && AC>=2 && DP>=5" -f "%CHROM\t%POS\t%REF\t%ALT\n" ${vcf} -o ${outdir}/${filename}.${mode}_ac2dp5.tab
bsub -J"extract_${mode}_${cohort}_aceq0dpgt5_${first_suffix}" -o"${outdir}/LOG/2.%J_extract_${mode}_${cohort}_aceq0dpgt5_${first_suffix}.o" -M 1000 -R "select[mem>=1000] rusage[mem=1000]" -q normal -- bcftools query -i"TYPE='${mode}' && AC==0 && DP>=5" -f "%CHROM\t%POS\t%REF\t%ALT\n" ${vcf} -o ${outdir}/${filename}.${mode}_ac0dp5.tab

#select sites with AC=1 and DP>5
bsub -J"extract_${mode}_${cohort}_aceq1dpgt5_${first_suffix}" -o"${outdir}/LOG/3.%J_extract_${mode}_${cohort}_aceq1dpgt5_${first_suffix}.o" -M 1000 -R "select[mem>=1000] rusage[mem=1000]" -q normal -- bcftools query -i"TYPE='${mode}' && AC==1 && DP>=5" -f "%CHROM\t%POS\t%REF\t%ALT\n" ${vcf} -o ${outdir}/${filename}.${mode}_ac1dp5.tab
...
bsub -J"extract_common_ingi_${mode}_${cohort}_aceq1dpgt5_${first_suffix}_INGI" -o"${outdir}/LOG/4.%J_extract_common_ingi_${mode}_${cohort}_aceq1dpgt5_${first_suffix}_INGI.o" -w "ended(extract_${mode}_${cohort}_aceq1dpgt5_${first_suffix})" -M 1000 -R "select[mem>=1000] rusage[mem=1000]" -q normal -- python /nfs/users/nfs_m/mc14/Work/bash_scripts/overlap_check.py INGI ${outdir}/${filename}.${mode}_ac1dp5.tab /lustre/scratch113/projects/esgi-vbseq/16112015_TRIESTE/INGI/UNION/${chr}/sites.txt ${outdir} ${mode}

#extract a list of sites in common with 1000G or/and UK10K
bsub -J"extract_common_ingi_${mode}_${cohort}_aceq1dpgt5_${first_suffix}_TGP3" -o"${outdir}/LOG/5.%J_extract_common_ingi_${mode}_${cohort}_aceq1dpgt5_${first_suffix}_TGP3.o" -w "ended(extract_common_ingi_${mode}_${cohort}_aceq1dpgt5_${first_suffix}_INGI)" -M 1000 -R "select[mem>=1000] rusage[mem=1000]" -q normal -- python /nfs/users/nfs_m/mc14/Work/bash_scripts/overlap_check.py TGP3 ${outdir}/${filename}.${mode}_ac1dp5.tab.INGI.${mode}.not_over.tab /lustre/scratch113/projects/esgi-vbseq/16112015_TRIESTE/TGPph3/UNION/${chr}/sites.txt ${outdir} ${mode}
bsub -J"extract_common_ingi_${mode}_${cohort}_aceq1dpgt5_${first_suffix}_UK10K" -o"${outdir}/LOG/6.%J_extract_common_ingi_${mode}_${cohort}_aceq1dpgt5_${first_suffix}_UK10K.o" -w "ended(extract_common_ingi_${mode}_${cohort}_aceq1dpgt5_${first_suffix}_INGI)" -M 1000 -R "select[mem>=1000] rusage[mem=1000]" -q normal -- python /nfs/users/nfs_m/mc14/Work/bash_scripts/overlap_check.py UK10K ${outdir}/${filename}.${mode}_ac1dp5.tab.INGI.${mode}.not_over.tab /lustre/scratch113/projects/esgi-vbseq/16112015_TRIESTE/UK10K/UNION/${chr}/sites.txt ${outdir} ${mode}
...
bsub -J"generate_ingi_${mode}_${first_suffix}_${cohort}_vcf" -o"${outdir}/LOG/8.%J_generate_ingi_${mode}_${first_suffix}_${cohort}_vcf.o" -w"ended(merge_common_ingi_${mode}_aceq0eq1gt2dpgt5_${first_suffix}_${cohort})" -M 3000 -R "select[mem>=3000] rusage[mem=3000]" -q normal -- bcftools view -i"TYPE='${mode}'" -R ${outdir}/${filename}.${mode}_extract.list -O z -o ${outdir}/PANEL/${filename}.${mode}_REF.vcf.gz ${vcf};tabix -p vcf ${outdir}/PANEL/${filename}.${mode}_REF.vcf.gz
bsub -J"generate_ingi_${mode}_${first_suffix}_${cohort}_vcf_tbi" -o"${outdir}/LOG/8.%J_generate_ingi_${mode}_${first_suffix}_${cohort}_vcf_tbi.o" -w"ended(generate_ingi_${mode}_${first_suffix}_${cohort}_vcf)" -M 3000 -R "select[mem>=3000] rusage[mem=3000]" -q normal -- tabix -p vcf ${outdir}/PANEL/${filename}.${mode}_REF.vcf.gz
