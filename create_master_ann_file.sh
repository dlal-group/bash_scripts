...
/nfs/team151/software/snptest_v2.5-beta4_Linux_x86_64_static/snptest_v2.5-beta4 -summary_stats_only -data ${file} ${sample_f} -o ${out_path}/${out_name}.stats -assume_chromosome X -hwe -log ${out_path}/${out_name}.log 
