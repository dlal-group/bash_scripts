...
/software/varinf/pkg/vcftools/current/bin/vcftools --gzvcf /lustre/scratch113/projects/esgi-vbseq/25082015_purging/26082015_ANNOTATED/1000G_FVG_VBSEQ.chr$c.vcf.gz.clean_ann.vcf.gz --counts2 --out c_$t/$t.$i.$c --positions /lustre/scratch113/projects/esgi-vbseq/20140430_purging/max/20150809_REVISION/conseqlists/$t/$c.$t --indv $i 
