...
mkdir -p  /lustre/scratch113/projects/esgi-vbseq/20140430_purging/46_SAMPLES/RESULTS/CONSEQUENCES/${cat}
...
zcat ${file} | cut -f -4 | bedtools intersect -a ${csq_file} -b stdin -wa -wb | fgrep -v -w MULTI|fgrep -v -w INDEL > /lustre/scratch113/projects/esgi-vbseq/20140430_purging/46_SAMPLES/RESULTS/CONSEQUENCES/${cat}/${filename}.${cat}
...
awk '{OFS="\t"}{print $1,$3,$3}' /lustre/scratch113/projects/esgi-vbseq/20140430_purging/46_SAMPLES/RESULTS/CONSEQUENCES/${cat}/${filename}.${cat} | sort -g -k1,1 -k2,2 > /lustre/scratch113/projects/esgi-vbseq/20140430_purging/46_SAMPLES/RESULTS/CONSEQUENCES/${cat}/${filename}.${cat}.regions
...
bcftools view --phased -U -V indels -S /lustre/scratch113/projects/esgi-vbseq/20140430_purging/46_SAMPLES/listpop/${pop}_unrelated.list -R /lustre/scratch113/projects/esgi-vbseq/20140430_purging/46_SAMPLES/RESULTS/CONSEQUENCES/${cat}/${fil} /lustre/scratch113/projects/esgi-vbseq/20140430_purging/UNRELATED/POP_MERGED_FILES/FIVE_POPS/20140711_ANNOTATED/${chr}.vcf.gz -O z -o /lustre/scratch113/projects/esgi-vbseq/20140430_purging/46_SAMPLES/RESULTS/CONSEQUENCES/${cat}/VCF/${chr}.${fil}.vcf.gz
tabix -p vcf /lustre/scratch113/projects/esgi-vbseq/20140430_purging/46_SAMPLES/RESULTS/CONSEQUENCES/${cat}/VCF/${chr}.${fil}.vcf.gz
...
outfile=/lustre/scratch113/projects/esgi-vbseq/20140430_purging/46_SAMPLES/RESULTS/CONSEQUENCES/${cat}/VCF/${chr}.${fil}.vcf.gz
