...
# bsub -J "input_prep_$1" -o "%J_input_prep_$1.o" -M2000 -R"select[mem>2000] rusage[mem=2000]" -q normal -- genotype_concordance_input_prep.sh 

outname_f1=`basename $1`.s1
outname_f2=`basename $2`.s2

#recode files in ped format
bsub -J "recode_f1" -o "%J_recode_f1.log" -M3000 -R"select[mem>3000] rusage[mem=3000]" \
-q normal "plink --noweb --bfile $1 --recode --allow-no-sex --out ${outname_f1}"

bsub -J "recode_f2" -o "%J_recode_f2.log" -M3000 -R"select[mem>3000] rusage[mem=3000]" \
-q normal "plink --noweb --bfile $2 --recode --allow-no-sex --out ${outname_f2}"
...
-q normal "plink --noweb --file ${outname_f1} --freq --allow-no-sex --out ${outname_f1}"
...
-q normal "plink --noweb --file ${outname_f2} --freq --allow-no-sex --out ${outname_f2}"
