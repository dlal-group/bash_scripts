...
zcat ${vcf_file} | vcf-annotate -a /lustre/scratch113/projects/fvg_seq/variant_refinemet/annotations/1TGP/ALL.wgs.phase1_release_v3.20101123.snps_indels_sv.sites.overlap_flag.tab.gz -d key=INFO,ID=TGP,Type=FLAG,Description="Variant present in TGP populations" -c CHROM,POS,-,-,-,INFO | vcf-annotate -a /lustre/scratch113/projects/fvg_seq/variant_refinemet/annotations/UK10K/ALL.wgs.UK10K.filtered.sites.overlap_flag.tab.gz -d key=INFO,ID=UK10K,Type=FLAG,Description="Variant present in UK10K populations" -c CHROM,POS,-,-,-,INFO  | bgzip -c > ${outdir}/${vcf_file}.gz
