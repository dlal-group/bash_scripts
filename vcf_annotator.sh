...
zcat ${vcf_file} | vcf-annotate -a /lustre/scratch113/projects/fvg_seq/variant_refinemet/annotations/1TGP/ALL.wgs.phase1_release_v3.20101123.snps_indels_sv.sites.tab -d key=INFO,ID=TGP,Type=Flag,Description="Variant present in TGP populations" -c CHROM,POS,-,-,-,INFO/TGP | vcf-annotate -a /lustre/scratch113/projects/fvg_seq/variant_refinemet/annotations/UK10K/ALL.wgs.UK10K.filtered.sites.tab.gz -d key=INFO,ID=UK10K,Type=Flag,Description="Variant present in UK10K populations" -c CHROM,POS,-,-,-,INFO/UK10K  | bgzip -c > ${outdir}/${filename}
