...
# bsub -J "generic_manipulation_${i}" -o "LOGS/%J_generic_manipulation_${i}.log" -e "LOGS/%J_generic_manipulation_${i}.err" -n 2,8 -M1000 -R"span[hosts=1] select[mem>1000] rusage[mem=1000]" -q small -- general_script.sh ${i}
bsub -J "generic_manipulation_${i}" -o "LOGS/%J_generic_manipulation_${i}.log" -e "LOGS/%J_generic_manipulation_${i}.err" -M4000 -R"select[mem>4000] rusage[mem=4000]" -q basement -- general_script.sh ${i}
