...
def liftBed(fin, fout, funlifted):
    params = dict()
    params['LIFTOVER_BIN'] = '/nfs/team151/software/bin/liftOver'
    params['OLD'] = fin
    params['CHAIN'] = '/lustre/scratch113/teams/soranzo/users/mc14/INGI_FVG/SEQ_CALLING/hg18ToHg19.over.chain.gz'
    params['NEW'] = fout
