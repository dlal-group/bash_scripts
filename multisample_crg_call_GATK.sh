...
-nt $CPU \
--dbsnp $DBSNP \
-o $OUTF/${chr}/${chr}.${reg_name}.multisampleinitial.allregions.${VARTYPE}.vcf \
...
--intervals $PROBE -glm ${VARTYPE} --output_mode $OMODE

#-o $OUTF/${chr}/1.${reg_name}.mutisampleInitialCall_all.${VARTYPE}.vcf \
